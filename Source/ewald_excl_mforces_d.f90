Subroutine ewald_excl_mforces_d &
           (iatm,rcut,alpha,epsq,xxt,yyt,zzt,rrt,engcpe_ex,vircpe_ex,stress,dQG_da,efx,efy,efz,fxc,fyc,fzc,mpi_counter)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  Use mpoles_module
  Use fflux_module,  Only : alf,non_alf_atms,max_atms_model,conv_B2A,model_list, &
                          & lxx,lyy,lzz,dCxx,dCyy,dCzz,atm_label_alias,mpi_list
  ...
  Integer           :: idi,jatm,limit,m,l,j,local_index,ind,alias,k
  ...
  Real( Kind = wp ) :: imp(1:mximpl),jmp(1:mximpl),poti(10),potj(10), &
                     & poti_dd(3),potj_dd(3),potj_cq,poti_cq,potj_qc(6),&
                     & poti_qc(6),potj_dq(3),poti_dq(3),potj_qd(6), &
                     & poti_qd(6),potj_qq(6),poti_qq(6)
              ...
              Do j=1,3
                ...
                If ((jatm <= natms) .AND. (alf(jatm,j) <= natms)) Then
                  ...
                  If (alf(jatm,j) .EQ. iatm) Then
                    efx(iatm) = efx(iatm) + dQ_dx*(poti(1)+poti(2)+poti(3)+poti(4))
                    efy(iatm) = efy(iatm) + dQ_dy*(poti(1)+poti(2)+poti(3)+poti(4))
                    efz(iatm) = efz(iatm) + dQ_dz*(poti(1)+poti(2)+poti(3)+poti(4))
                  Else
...
!                    Call fflux_cmoment_derivs(jatm,j,l,dQ_dx,dQ_dy,dQ_dz,dQ_da,CartPoles)
                    ...
                    If (alf(jatm,j) .EQ. iatm) Then
                      efx(iatm) = efx(iatm) + dQ_dx*(poti(4+l)+poti_dd(l))
                      efy(iatm) = efy(iatm) + dQ_dy*(poti(4+l)+poti_dd(l))
                      efz(iatm) = efz(iatm) + dQ_dz*(poti(4+l)+poti_dd(l))
                    Else
...
!                    Call fflux_cmoment_derivs(iatm,j,l,dQ_dx,dQ_dy,dQ_dz,dQ_da,CartPoles)
                ...
                If ((jatm <= natms) .AND. (alf(jatm,j) <= natms)) Then
                  ...
                  If (alf(jatm,j) .EQ. iatm) Then
                    efx(iatm) = efx(iatm) + dQ_dx*(poti(1)+poti(2)+poti(3)+poti(4)+poti_cq)
                    efy(iatm) = efy(iatm) + dQ_dy*(poti(1)+poti(2)+poti(3)+poti(4)+poti_cq)
                    efz(iatm) = efz(iatm) + dQ_dz*(poti(1)+poti(2)+poti(3)+poti(4)+poti_cq)
                  Else
                  ...
                  Do l=1,3
                    ...
                    If (alf(jatm,j) .EQ. iatm) Then
                      efx(iatm) = efx(iatm) + dQ_dx*(poti(4+l)+poti_dd(l)+poti_dq(l))
                      efy(iatm) = efy(iatm) + dQ_dy*(poti(4+l)+poti_dd(l)+poti_dq(l))
                      efz(iatm) = efz(iatm) + dQ_dz*(poti(4+l)+poti_dd(l)+poti_dq(l))
                    Else
...
!                    Call fflux_cmoment_derivs(jatm,j,l,dQ_dx,dQ_dy,dQ_dz,dQ_da,CartPoles)
                    ...
                    If (alf(jatm,j) .EQ. iatm) Then
                      efx(iatm) = efx(iatm) + dQ_dx*(poti_qc(l-3)+poti_qd(l-3)+poti_qq(l-3))
                      efy(iatm) = efy(iatm) + dQ_dy*(poti_qc(l-3)+poti_qd(l-3)+poti_qq(l-3))
                      efz(iatm) = efz(iatm) + dQ_dz*(poti_qc(l-3)+poti_qd(l-3)+poti_qq(l-3))
                    Else
