Subroutine mpoles_rotmat_export(mdir,mlast,ixyz0,CartPoles)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  Real( Kind = wp ), Intent( InOut ) :: CartPoles(mximpl,mxatms)
...
! pack rotation matrices and infinitely rotated matrices
              ...
              buffer(imove+1 + idl1 : imove + idl2) = CartPoles(:,i)!mprotx(:,i)
...
! unpack rotation matrices and infinitesimal rotation matrices
     ...
     CartPoles(:,mlast) = buffer(j+1 + idl1 : j + idl2)
