...
! FFLUX file channel number - BCBS 01/2019

  Integer, Parameter :: nffluxdt = 32

! FFLUX dipole file channel number - BCBS 03/2019

  Integer, Parameter :: ndipoledt = 33
! FFLUX energy file channel number
  Integer, Parameter :: nenergydt = 34
! FFLUX force file channel number
  Integer, Parameter :: nforcedt = 35
